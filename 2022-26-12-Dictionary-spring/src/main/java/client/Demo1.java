...
public class Demo1 {
	...
	public static void main(String[] args) {
...

		{
			...
			word = rt.postForObject(baseUrl, word, EntryWord.class);
			System.out.println(word);
			System.out.println(word.getSentences());
		}
		{
			List<ExampleSentence> exampleSentences = new ArrayList<>();
			exampleSentences.add(new ExampleSentence(0, "that Rabbit climbed the tree", null));
			exampleSentences.add(new ExampleSentence(0, "that Rabbit drank milk", null));
			EntryWord word = new EntryWord(0, "Rabbit", "a nice animal that do hops", exampleSentences);
			System.out.println(word);
			System.out.println(word.getSentences());
			word = rt.postForObject(baseUrl, word, EntryWord.class);
			System.out.println(word);
