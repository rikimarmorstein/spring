...
public class CinemaControllerAdvice {
	@ExceptionHandler(CinemaCustomException.class)
	@ResponseStatus(HttpStatus.BAD_REQUEST) // 400
	public ErrDetails handleCatSystemExcptions(CinemaCustomException e) {
		return new ErrDetails("Cinema System Exception: ", e.getMessage());
	}
